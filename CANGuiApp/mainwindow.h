...
private slots: // Functions that capture events write these blocks as slot functions.
    ...
    void on_busFeatures_setFrameDelayTime_clicked();
    void on_busFeatures_setLingerMode_clicked();
    void on_busFeatures_getLingerMode_clicked();
    void on_busFeatures_setSelfAck_clicked();
    void on_busFeatures_getSelfAck_clicked();
    void on_busFeatures_setBRSIgnore_clicked();
    void on_busFeatures_getBRSIgnore_clicked();
    void on_busFeatures_getDriverClockReference_clicked();
